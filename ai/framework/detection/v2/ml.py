import cv2
import torch
from framework.contracts import DetectionPrediction, DetectionPredictions, SegmentationDatasetAdapter
from framework.detection.v1.ml import MLM as MLMv1
...
class MLM(MLMv1):
    ...
    def __init__(
        ...
        if dataset:
            ...
            self.object_labels = dataset.id_to_name
            ...
            self.model = MaskRCNN(
                ...
                disease_label_ids=disease_label_ids,
